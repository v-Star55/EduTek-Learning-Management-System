...
import { generateMeetingID } from "../utils/generateMeetingsld";
...
const myMeeting = async (element: any) => {
  const kitToken = ZegoUIKitPrebuilt.generateKitTokenForTest(
    1668723881, // Replace with your app ID
    "007118723006f1a6918bdee62bce9956", // Replace with your server secret
    params.id as string,
